...
f2 ist das Ziel für den Springer für die königliche Gabel. Also \mainline{1... Ng4} und
...
Matt in 3 mit Turmopfer: \mainline{1.. Rg1+ 2. Kxg1 Qg6+ 3. Kf1 Qg2#}
...
En passant gewinnt den Springer \mainline{1. cxb6 Rxb6 2. Qxa5}.
...
\mainline{1... Re2} droht Matt auf h2. Der Springer nimmt mit \mainline{2. Nxe2} und
Schwarz opfert die Dame mit \mainline{2... Qf3+ 3. Bxf3}. Zuletzt gibt's Matt mit
\mainline{3... Bxf3#}.
...
\index{Materialgewinn}

\pagebreak

Unser Springer schlägt den schwarzen Springer und öffnet die Linie. Unser Turm drängt den
König vom Läufer weg und die Dame holt den Läufer: \mainline{1. Nxh5 gxh5 2. Rg1+ Kh8 3.
Qxh6}
...
Matt in 2: \mainline{1. Rxg6 hxg6 2. g5#}
...
Matt in 2: \mainline{1. Qf5 h5 2. Qxh5#}
...
\index{Hängende Figur}

\pagebreak

Der Turm auf d8 wird drei mal angegriffen, aber nur zwei mal verteidigt.
Daher gewinnt \mainline{1. Rxd8 Nxd8 2. Rxd8 Rxd8 3. Qxd8} den Springer.
...
Springergabel: \mainline{1... Ne5+ 2. Ke3 Nxc4+}
