...
\begin{frame}
  \begin{itemize}
    \item \WhiteKingOnWhite \WhiteQueenOnWhite \WhiteRookOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteRookOnWhite \WhiteRookOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteQueenOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteRookOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteBishopOnWhite \WhiteBishopOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteRookOnWhite \WhiteBishopOnWhite \WhiteKnightOnWhite \BlackKingOnWhite
    \item \WhiteKingOnWhite \WhiteQueenOnWhite \BlackKingOnWhite \BlackPawnOnWhite
    \item \WhiteKingOnWhite \WhiteQueenOnWhite \BlackKingOnWhite \BlackBishopOnWhite
    \item \WhiteKingOnWhite \WhiteQueenOnWhite \BlackKingOnWhite \BlackKnightOnWhite
  \end{itemize}
\end{frame}
